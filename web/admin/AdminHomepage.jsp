...
<html lang="en">
    ...
    <body class="ttr-opened-sidebar ttr-pinned-sidebar">
                                    ...
                                    <ul>
                                        <li>
                                            <span class="new-users-pic">
                                                <img src="assets/assetsAdmin/images/testimonials/pic1.jpg" alt=""/>
                                            </span>
                                        ...
                                        <li>
                                            <span class="new-users-pic">
                                                <img src="assets/assetsAdmin/images/testimonials/pic2.jpg" alt=""/>
                                            </span>
                                            <span class="new-users-text">
                                        ...
                                        <li>
                                            <span class="new-users-pic">
                                                <img src="assets/assetsAdmin/images/testimonials/pic3.jpg" alt=""/>
                                            </span>
                                            <span class="new-users-text">
        ...
        <script src='assets/assetsAdmin/vendors/calendar/moment.min.js'></script>
        <script src='assets/assetsAdmin/vendors/calendar/fullcalendar.js'></script>
