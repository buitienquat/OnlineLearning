...
<div id="banModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="banModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form id="banForm" action="/swp-project/updatecourse" method="POST">
    ...
    <ul class="db-breadcrumb-list">
        <li><a href="/swp-project/CourseList?status=1">Active</a></li>
        <li><a href="/swp-project/CourseList?status=0">Ban</a></li>
        <li><a href="/swp-project/CourseList?status=2">Pending</a></li>
    </ul>
</div>
                <div class="row">
		...
		<li class="card-courses-categories">
                                            ...
                                            <div class="row card-courses-dec">
                                                ...
                                                <form action="/swp-project/updatecourse" method="POST">
                                                    <div class="col-md-12">
