<%-- 
    Document   : newjsp1
    Created on : Jun 9, 2024, 11:26:56 PM
    Author     : vuduc
--%>
...
<html lang="en">
    ...
    <body class="ttr-opened-sidebar ttr-pinned-sidebar">
                    ...
                    <div class="col-md-6 col-lg-3 col-xl-3 col-sm-6 col-12">
                        <div class="widget-card widget-bg4">					 
                            <div class="wc-item">
                                ...
                                <span class="wc-stats">
                                    <span class="counter"> ${lenght}</span>
                                </span>		
                                <div class="progress wc-progress">
                                    ...
                                    <ul>
                                        <li>
                                            <span class="new-users-pic">
                                                <img src="assets/assets_admin/images/testimonials/pic1.jpg" alt=""/>
                                            </span>
                                        ...
                                        <li>
                                            <span class="new-users-pic">
                                                <img src="assets/assets_admin/images/testimonials/pic2.jpg" alt=""/>
                                            </span>
                                            <span class="new-users-text">
                                        ...
                                        <li>
                                            <span class="new-users-pic">
                                                <img src="assets/assets_admin/images/testimonials/pic3.jpg" alt=""/>
                                            </span>
                                            <span class="new-users-text">
        ...
        <script src='assets/assets_admin/vendors/calendar/moment.min.js'></script>
        <script src='assets/assets_admin/vendors/calendar/fullcalendar.js'></script>
