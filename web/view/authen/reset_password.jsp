	...
	<div class="account-form">
		...
		<div class="account-form-inner">
			<div class="account-container">
				...
				<form class="contact-bx" action="<%=request.getContextPath()%>/resetPasswordServlet" method="post" onsubmit="return validateForm()">
					<div class="row placeani">
						...
						<div class="col-lg-12 m-b30">
							<button type="submit" value="Reset Password" class="btn button-md">Submit</button>
						</div>
					</div>
				</form>
			</div>
